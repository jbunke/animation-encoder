...
@Deprecated
public final class GIFWriterNoTransparency implements AnimWriter {
    private static final GIFWriterNoTransparency INSTANCE;

    static {
        INSTANCE = new GIFWriterNoTransparency();
    }

    private GIFWriterNoTransparency() {

    }

    public static GIFWriterNoTransparency get() {
        return INSTANCE;
    }
